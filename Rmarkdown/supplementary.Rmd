...
p <- ggtree(
     ...
     theme_tree2()
# the scale_x_break of ggbreak is used to set an x axis break point for the ggtree plot
# breaks parameter means the break point, here, the plot will be split two subplots
