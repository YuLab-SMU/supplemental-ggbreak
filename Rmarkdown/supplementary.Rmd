...
p1 <- p + scale_wrap(n=4) +
    geom_rect(aes(xmin=2432, xmax=2512, ymin=-4.5, ymax=4),fill='#57c3c2',alpha = 0.002) +
...
```{r cut,fig.width=12, fig.height=10, error=FALSE, warning=FALSE, message=FALSE,dpi=300}
